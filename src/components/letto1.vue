...
<template>
  <div class="newlists" id="newlists">
        <h2 class="tit mt10" v-for="(value, key) in newList"  v-if=" key==0 "><i class="iconfont icon-pl3"></i><span>排例3</span></h2>
        <ul class="nlist npad">
  ...
  methods:{
      ...
      newVue:function(num){
        ...
        axios.interceptors.response.use(response => {
          ...
          var url=window.encodeURIComponent("f.apiplus.net/pl3-20.json");
            ...
            .then(res => {
              ...
              if(str.indexOf('请求频率过')>-1){
                 res.data = sessionStorage.getItem('pl3');
              }else{
                sessionStorage.setItem('pl3',res.data);
              }
