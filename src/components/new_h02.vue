  ...
  <div class="newlists" id="newlists">
        <ul class="nlist">
            <li v-for="(value, key) in newList">
                ...
                <span class="nimgbig"><img :src="require('./../components/img/yl_1.jpg?1111')" alt=""></span>
                </router-link>
            </li>
        </ul>
  </div>
      ...
      newVue:function(num){
        ...
        axios.interceptors.response.use(response => {
           ...
           // this.$store.commit('isloadhid');
            ...
            axios.get('http://154.48.238.35:8085/UserService.svc/NewsList?newstype=娱乐&pageindex=' + 3 + '&pagesize=1')  /// http://www.hd.me/data.php?callback=dosomething    static/news.json?num  static/news.json  http://misc.opencai.net/consts/lotts.json   /static/news.json
            .then(res => {
              console.log(res)
