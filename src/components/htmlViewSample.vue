...
<template>
  <div class="newlists" id="newlists">
   ...
   <div class="menu_w">
   <ul class="smeu">
       <li><router-link :to="{ name: 'newlists1'}">福彩3D</router-link></li>
       <li><router-link :to="{ name: 'newlists2'}">七星彩</router-link></li>
       <!-- <li><router-link :to="{ name: 'newlists3'}">军事</router-link></li> -->
       <li><router-link :to="{ name: 'newlists4'}">体育</router-link></li>
       <li><router-link :to="{ name: 'newlists5'}">排例3</router-link></li>
    </ul>
   <div class="marw">
