...
<template>
  <div class="newlists" id="newlists">
        <h2 class="tit mt10" v-for="(value, key) in newList"  v-if=" key==0 "><i class="iconfont icon-fc3d"></i><span>福彩3D</span><div class="bt">第 {{value.expect}} 期开奖号码</div></h2>
        <ul class="nlist npad">
  ...
  methods:{
      ...
      newVue:function(num){
        ...
        axios.interceptors.response.use(response => {
          ...
          var url=window.encodeURIComponent("f.apiplus.net/dlt-10.json");
            ...
            .then(res => {
              ...
              if(str.indexOf('请求频率过')>-1){
                 res.data = sessionStorage.getItem('dlt');
              }else{
                sessionStorage.setItem('dlt',res.data);
              }
