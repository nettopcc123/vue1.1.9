...
<template>
  <div class="newlists" id="newlists">
        <h2 class="tit mt10" v-for="(value, key) in newList"  v-if=" key==0 "><i class="iconfont icon-pl5"></i><span>排例5</span><div class="bt">第 {{value.expect}} 期开奖号码</div></h2>
        <ul class="nlist npad">
  ...
  methods:{
      ...
      newVue:function(num){
        ...
        axios.interceptors.response.use(response => {
          ...
          var url=window.encodeURIComponent("f.apiplus.net/pl5-10.json");
