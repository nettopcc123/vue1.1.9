...
<template>
  <div class="newlists" id="newlists">
        <h2 class="tit mt10" v-for="(value, key) in newList"  v-if=" key==0 "><i class="iconfont icon-qxc"></i><span>七星彩</span></h2>
        <ul class="nlist npad">
  ...
  methods:{
      ...
      newVue:function(num){
        ...
        axios.interceptors.response.use(response => {
          ...
          var url=window.encodeURIComponent("f.apiplus.net/qxc-20.json");
